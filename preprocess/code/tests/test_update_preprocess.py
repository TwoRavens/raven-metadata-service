...
class UpdatePreprocessTest(unittest.TestCase):
    ...
    def test_20_update(self):
        ...
        self.maxDiff = None
        self.assertEqual(var_display_util,self.expected_output)
    ...
    def test_40_update(self):
        ...
        var_display_modify = VariableDisplayUtil(pre_file, self.update_json_01).var_display()
        var_err = VariableDisplayUtil(pre_file, self.update_json_01).error_messages
        self.assertEqual(ValueError,var_display_modify)
        print("Error : ",var_err)
    ...
    def test_60_update(self):
        ...
        var_display_modify = VariableDisplayUtil(self.preprocess_json_01, update).var_display()
        var_err = VariableDisplayUtil(self.preprocess_json_01,update).error_messages
        self.assertEqual(ValueError, var_display_modify)
        print("Error : ",var_err)
