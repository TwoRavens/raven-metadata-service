...
class PreprocessRunner(object):
    ...
    def get_self_variables_dict(self, as_string=False):
        """For final output"""
        return self.get_self_variables_labels()

        #return json.dumps(ordered_dict, cls=NumpyJSONEncoder,separators=(',',':'))
    ...
    def get_final_dict(self, as_string=False, **kwargs):
        ...
        overall_dict['self'] = self.get_self_variables_dict() # add the "self" section
